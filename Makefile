...
go_lint: golint_deps go_test_tag_lint
	...
	golint -set_exit_status $(WPTD_PATH)/api/...
	# Skip revisions/test
	golint -set_exit_status $(WPTD_PATH)/revisions/{announcer,api,epoch,git,service}/...
	golint -set_exit_status $(WPTD_PATH)/shared/...
	golint -set_exit_status $(WPTD_PATH)/util/...
	golint -set_exit_status $(WPTD_PATH)/webapp/...
	golint -set_exit_status $(WPTD_PATH)/webdriver/...
